...
class ItemPage extends Component {
    ...
    render() {
        ...
        console.log("result", this.props.match.params.ownerid)
                                ...
                                <div className="shadow p-3 mb-5 bg-white rounded">
                                    <div id="demo" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <img src={images(this.props.singleSaleItem ? "./" + `${this.props.singleSaleItem.image1}`: "./default.png")} alt="Image 1" width="1100" height="500"></img>
                                            </div>
                                            <div class="carousel-item">
                                            <img src={images(this.props.singleSaleItem ? "./" + `${this.props.singleSaleItem.image2}`: "./default.png")} alt="Image 2" width="1100" height="500"></img>
                                            </div>
                                            <div class="carousel-item">
                                            <img src={images(this.props.singleSaleItem ? "./" + `${this.props.singleSaleItem.image3}`: "./default.png")} alt="Image 3" width="1100" height="500"></img>
                                            </div>
                                            <div class="carousel-item">
                                            <img src={images(this.props.singleSaleItem ? "./" + `${this.props.singleSaleItem.image4}`: "./default.png")} alt="Image 4" width="1100" height="500"></img>
                                            </div>
                                            <div class="carousel-item">
                                            <img src={images(this.props.singleSaleItem ? "./" + `${this.props.singleSaleItem.image5}`: "./default.png")} alt="Image 5" width="1100" height="500"></img>
                                            </div>
                                            <div class="carousel-item">
                                            <img src={images(this.props.singleSaleItem ? "./" + `${this.props.singleSaleItem.image6}`: "./default.png")} alt="Image 6" width="1100" height="500"></img>
                                            </div>                                            
                                        </div>
