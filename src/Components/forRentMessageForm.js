...
class forSale extends Component {
    ...
    renderRateField = ({input, fieldName, inputType}) => {
        return(
            <div className="input-group mb-3">
                <input {...input} type={inputType} className="form-control" style={{backgroundColor:"white", color:"black"}}/>
                    ...
                    <div style={{marginLeft: "20pt", marginRight: "20pt"}}>
                        ...
                        <div>
                            <form onSubmit={this.props.handleSubmit(this.onSubmit)}>
                                ...
                                <Field name="offerRate" component={this.renderRateField} fieldName="per Hour" inputType="number"/>
                                <p>Rent Duration</p>
                                <div className="row">
                                    <div className="col-sm-6">
                                        <Field name="offerDurationDays" component={this.renderRateField} fieldName="days" inputType="number"/>
                                    </div>
                                    <div className="col-sm-6">
                                        <Field name="offerDurationHours" component={this.renderRateField} fieldName="hours" inputType="number"/>
                                    </div>
                                </div>
                                <div className="form-group">
                                    <Field name="messageBody" component={this.renderField} label="Message body" style="form-control" rows="20" type="text"/>
                                </div>                
                                <button type="submit" className="btn btn-primary float-right" style={{marginBottom: "20pt"}}>Send message</button>
                            </form>
                        </div>
                    </div>     
                </div>
