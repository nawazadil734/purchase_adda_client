                ...
                <div className="container">
                    <div style={{marginLeft: "20pt", marginRight: "20pt"}}>
                        ...
                        <div>
                            ...
                            <div className="input-group mb-3">
                                <input type="number" className="form-control" style={{backgroundColor:"white", color:"black"}} value="60" readOnly/>
                            ...
                            <textarea readOnly class="form-control" style={{fontFamily:"'Open Sans', sans-serif", backgroundColor:"white", color:"black", marginBottom:"10pt"}} rows="18">
